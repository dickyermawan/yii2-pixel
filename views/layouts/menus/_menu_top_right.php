...
<ul id="menu-navbar-top-right" class="nav navbar-nav navbar-menu-user navbar-right">
    <li class="dropdown">
        <a href="<?= Url::to(['/site/message-notifications']); ?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">
            ...
            <span class="px-navbar-icon-label">Notifikasi</span>
        ...
        <div class="dropdown-menu p-a-0" style="width: 300px;"> <!-- begin .dropdown-menu -->
            <div id="navbar-messages-notifications" style="max-height: 280px; position: relative;">
                ...
                <?php endfor; ?>
            <a href="<?= Url::to(['/site/message-notifications']); ?>" class="widget-more-link">PESAN LAINNYA</a>
        </div> <!-- / .dropdown-menu -->
    </li>
    ...
    <?= NavTop::widget([
        ...
        'items' => [
            [
                'label' => Html::img('@web/images/notifications/043-like.png', ['class' => 'px-navbar-image']) .
                           '<span class="hidden-md">' . (isset(Yii::$app->user->identity->nama) ? Yii::$app->user->identity->nama : 'Nama Guest') .'</span>' .
                    ...
                    [
                        ...
                        'linkOptions' => [
                            ...
                            'data' => [
                                ...
                                'confirm-title' => 'Konfirmasi Log-out',
                                'confirm-message' => 'Apakah Anda yakin hendak Log-out?'
                            ]
                        ],
                    ],
                ]
