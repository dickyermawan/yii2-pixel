            ...
            <div class="box m-a-0">
                <div class="box-row">
                    ...
                    <div class="box-cell col-md-7">
                        ...
                        <h4 class="m-t-0 m-b-4 text-xs-center font-weight-semibold">Masuk ke Akun Anda</h4>
                        ...
                        <fieldset class="page-signin-form-group form-group form-group-lg">
                            ...
                            <input type="text" class="page-signin-form-control form-control" id="loginform-username" name="LoginForm[username]" placeholder="Username atau Email">
                        </fieldset>
                        ...
                        <?php $formResetPassword = ActiveForm::begin([
                            ...
                            <h4 class="m-t-0 m-b-4 text-xs-center font-weight-semibold">Setel Ulang Password</h4>

                            <?php // $formResetPassword->field($modelForgotPassword, 'userEmail')->input('email', ['class' => 'form-control', 'placeholder' => 'Email'])->label(false) ?>
